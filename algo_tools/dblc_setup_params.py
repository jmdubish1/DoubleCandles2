...
class DblRunParams:
    def __init__(self, param_run_dict):
        ...
        self.stopLossPercents = self.adj_params(param_run_dict['stopLossPercents'], 10000)
        self.takeProfitPercents = self.adj_params(param_run_dict['takeProfitPercents'], 10000)
...
class DblSetupParams:
    def __init__(self, setup_params, param_run_dict):
        ...
        self.strat_loc = r'C:\Users\jmdub\Documents\Trading\Futures\Strategy Info\Double_Candles_2'
